  ...
  describe('with custom revert message', function () {
    describe('sub', function () {
      ...
      it('reverts if subtraction result would be negative', async function () {
        ...
        await expectRevert(this.safeMath.subWithMessage(a, b, 'MyErrorMessage'), 'evm: execution reverted');
      });
    });
    ...
    describe('div', function () {
      ...
      it('reverts on division by zero', async function () {
        ...
        await expectRevert(this.safeMath.divWithMessage(a, b, 'MyErrorMessage'), 'evm: execution reverted');
      });
    });
    ...
    describe('mod', function () {
      ...
      it('reverts with a 0 divisor', async function () {
        ...
        await expectRevert(this.safeMath.modWithMessage(a, b, 'MyErrorMessage'), 'evm: execution reverted');
      });
    });
  });
